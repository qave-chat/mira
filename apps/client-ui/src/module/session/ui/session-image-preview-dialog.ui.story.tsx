...
const meta: Meta<typeof SessionImagePreviewDialog> = {
  title: "Module/Session/SessionImagePreviewDialog",
...
export const ComposerStrip: Story = {
  render: () => (
    <div className="flex items-center gap-2 rounded-2xl border border-border bg-background/95 p-3 shadow-xl shadow-black/15 ring-1 ring-foreground/10">
      <SessionImagePreviewDialog alt="Uploaded workflow screenshot" src={sampleImage} />
      <SessionImagePreviewDialog
        alt="Uploading workflow screenshot"
        src={sampleImage}
        isUploading
      />
      <SessionImagePreviewDialog
        alt="Removable workflow screenshot"
        src={sampleImage}
        onRemove={() => undefined}
      />
    </div>
