...
const particleSrc = `data:image/svg+xml,${encodeURIComponent(`
...
const meta: Meta<typeof ParticleField> = {
  title: "Module/Auth/ParticleField",
  ...
  decorators: [
    (Story) => (
      <div className="h-[520px] w-[420px] overflow-hidden rounded-xl border bg-muted">
        <Story />
      </div>
    ),
  ],
